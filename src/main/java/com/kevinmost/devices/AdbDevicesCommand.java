...
import com.kevinmost.command.ProvidedResourceCommand;
import org.jetbrains.annotations.NotNull;

import java.util.ArrayList;
import java.util.List;

class AdbDevicesCommand extends ProvidedResourceCommand<List<AdbDevice>> {

    @Override
    protected String getTerminalCommand(String... args) {
        return "adb devices -l";
    }

    @Override
    @NotNull
    protected List<AdbDevice> transformToResult(String stdOut, String stdErr) {
